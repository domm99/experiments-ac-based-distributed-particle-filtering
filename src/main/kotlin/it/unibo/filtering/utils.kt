 ...
 */
fun Position<*>.toEuclidean2DPosition(): Euclidean2DPosition =
    Euclidean2DPosition(coordinates[0], coordinates[1])

/**
 * Gets the current position of the device in the environment as a [Euclidean2DPosition].
 */
fun CollektiveDevice<*>.coordinates(): Euclidean2DPosition =
    environment.getPosition(node).toEuclidean2DPosition()
